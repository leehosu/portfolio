...
const projectList = [
  ...
  {
    id: 3,
    date: "April 2019 - Proceeding / Pause",
    title: "연구실 Blog 개발",
  ...
  {
    id: 4,
    date: "February 2020 - Proceeding",
    title: "다모임 쇼핑몰 Square 개발",
    stack: "TypeScript, React.JS, Django 등",// eslint-disable-next-line
    contents: "TypeScript, React.JS로 Front 개발하고 Django로 back을 구성하여 개발한 프로젝트입니다.\
                Front는 제가 개발하였고 Back은 다른 개발자분이 개발하였습니다.\
                사용자 누구나 쇼핑몰에 아이템을 등록할 수 있으며 해당 쇼핑몰과 연동되게 해주는\
                쇼핑 다모임 웹 사이트입니다.\
                RestAPI를 통해 JSON형식으로 받아온 데이터를 Handling하여 구현하였습니다.",
    url: "https://github.com/Squre-mall"
  }
